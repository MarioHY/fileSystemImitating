...
///////////////////////////////////////////
/**
* @brief 初始化文本，将文本内容导入自定义链表
*/
TextController::TextController(std::string inputFile, std::string outputFile)
{
	//////////////////////////////打开文件并初始化信息////////////////////
...
//////////////////////////////////////////////////////////////
std::string TextController::getFilePath()
{
